    ...
    capabilities: {
      tools: [
        ...
        },
        {
          name: "create_order",
          description:
            "Place an order for a product. Supports Bitcoin payment methods. Requires read_write or full_access API key.",
          parameters: {
            productId: {
              type: "string",
              required: true,
        ...
        },
        {
          ...
          description:
            "Get available Bitcoin payment methods for a specific seller.",
          parameters: {
            sellerPubkey: {
              type: "string",
              required: true,
